...
\includeonly{chapter0,Intro/chapter1} % added to compile chapters separately (comment out for full thesis)
...
% if you use BIBTEX
%\bibliographystyle{IEEEtran} %bh commented out
\bibliographystyle{plainnat}
%\bibliography{thesis} %bh commented out
...
%bh commented out- insert personal CV from pdf above
%\begin{vita}
%
