...
\includeonly{chapter0,Intro/chapter1,3D-Saliency/chapter5}%,Contour/chapter2,3D-Surface/chapter4,3D-Saliency/chapter5}
...
\bibliography{niebase} % include niebase_supp for other references

% bh Add CV to end of file (uncomment to include)
%\cleardoublepage % add CV to TOC
%\phantomsection
%\addcontentsline{toc}{chapter}{Curriculum Vitae}

%\includepdf[pages=-,offset=0 -20]{CV/CV_Brian_Hu.pdf} % use offset to avoid cutting off header
