...
\usepackage[round,authoryear]{natbib} %for author-year citations (replaces default)
...
\includeonly{chapter0}%,Intro/chapter1,Contour/chapter2,3D-Surface/chapter4,3D-Saliency/chapter5}
