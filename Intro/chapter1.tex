...
%A citation without brackets \citet{B}. 
%Multiple citations \citep{A, B, C}.
...
psychophysical data,~\cite{Nakayama_etal95} proposed that surface
...
\begin{figure}[h]
  %\vspace{-60pt}
  \centering 
  \includegraphics[width=.3\textwidth]{Intro/figs/groupingcircuit}
